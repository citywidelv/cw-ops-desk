  ...
  return [
    {
      ...
      ss: function () { return cwSS_(); }, tab: 'Open Opportunities',
    ...
    },
    {
      ...
      ss: function () { return cwSS_(); }, tab: 'Responses',
...
// ############################################################################
// UNIFORM ORDERS (uo_ kinds). Lives here since Sep 24 2026 because the editor's
// Add-file menu could not be driven that day; the same code is archived as
// cw-ops-desk/UniformOrders.gs and can be moved into its own file any time.
// ############################################################################
// ============================================================
